...
namespace PoliticsMod.Localization.Languages
{
    ...
    public static class En
    {
        public static Language Build()
        {
            ...
            s[L10nKeys.Stats_Election_Label] = "Election:";
            s[L10nKeys.Stats_Election_Item] = "Election #{0} ({1}-{2})";
            s[L10nKeys.Stats_District_Label] = "District:";
            s[L10nKeys.Stats_District_CityWide] = "City-Wide";
            s[L10nKeys.Stats_District_Unzoned] = "Outer City (Unzoned)";
            s[L10nKeys.Stats_District_PartyResults] = "District Election Results";
            s[L10nKeys.Stats_Senate_Title] = "Senate (Upper House - 1 Seat per District)";
            s[L10nKeys.Stats_Senate_Summary] = "Senate: {0} seats total";
            s[L10nKeys.Stats_Senate_Winner] = "Senator Elected: {0} ({1:P1}, {2} votes)";
            s[L10nKeys.Stats_Senate_NoWinner] = "No Senator elected";
            s[L10nKeys.Stats_Senate_SeatSuffix] = "{0} seat(s)";
            s[L10nKeys.Stats_CategoryTotal_Label] = "Category Total";
            s[L10nKeys.Panel_Senate_Summary] = "Senate: {0}";
