namespace PoliticsMod.Localization
{
    ...
    public static class L10nKeys
    {
        ...
        public const string Stats_Election_Label = "Stats_Election_Label";
        public const string Stats_Election_Item = "Stats_Election_Item";
        public const string Stats_District_Label = "Stats_District_Label";
        public const string Stats_District_CityWide = "Stats_District_CityWide";
        public const string Stats_District_Unzoned = "Stats_District_Unzoned";
        public const string Stats_District_PartyResults = "Stats_District_PartyResults";
        public const string Stats_Senate_Title = "Stats_Senate_Title";
        public const string Stats_Senate_Summary = "Stats_Senate_Summary";
        public const string Stats_Senate_Winner = "Stats_Senate_Winner";
        public const string Stats_Senate_NoWinner = "Stats_Senate_NoWinner";
        public const string Stats_Senate_SeatSuffix = "Stats_Senate_SeatSuffix";
        public const string Stats_CategoryTotal_Label = "Stats_CategoryTotal_Label";
        public const string Panel_Senate_Summary = "Panel_Senate_Summary";
